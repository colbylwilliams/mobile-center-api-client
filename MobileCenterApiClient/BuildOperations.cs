...
namespace MobileCenterApi
{
    ...
    /// </summary>
    public partial class BuildOperations : IServiceOperations<MobileCenterApiClient>, IBuildOperations
    {
        /// <summary>
        ...
        /// </param>
        public BuildOperations(MobileCenterApiClient client)
        {
            if (client == null) 
            {
        ...
        /// <summary>
        /// Gets a reference to the MobileCenterApiClient
        /// </summary>
        public MobileCenterApiClient Client { get; private set; }
